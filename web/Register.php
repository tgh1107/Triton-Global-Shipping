	...
	<div class="login">
		...
		<form>
			...
			<tr>
				...
				<td><input class="info" type="text" name="" placeholder="Enter your name"> </td>
			</tr>
			<tr>
				<td align="left">Email address:</td>
				<td><input class="info" type="text" name="" placeholder="Enter your email">
			</tr>
			<tr>
				<td align="left"> Contact number:</td>
				<td><input class="info" type="text" name="" placeholder="Enter your contact number"></td>
			</tr>
			<tr>
				<td align="left"> Address: </td>
				<td><input class="info" type="text" name="address" placeholder="Enter your address"></td>
			</tr>
			<tr>
				<td align="left"> Password: </td>
				<td><input class="info" type="password" name="" placeholder="Enter password"></td>
			</tr>
			<tr>
				<td align="left"> Confirm Password:</td>
				<td><input class="info" type="password" name="" placeholder="Retype your password"> </td>
			</tr>
			</table>
		</form>
